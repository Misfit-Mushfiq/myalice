...
List<S2Choice<String>> ticketType = [
  S2Choice<String>(value: 'Pending Tickets', title: 'Pending Tickets'),
  S2Choice<String>(value: 'Resolved Tickets', title: 'Resolved Tickets'),
];
